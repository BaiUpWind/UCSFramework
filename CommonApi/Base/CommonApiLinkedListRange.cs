...
namespace CommonApi
{
    ...
    public struct CommonApiLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public CommonApiLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly CommonApiLinkedListRange<T> m_GameFrameworkLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(CommonApiLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new Exception("Range is invalid.");
