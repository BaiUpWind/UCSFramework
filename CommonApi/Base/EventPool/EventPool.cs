...
namespace CommonApi
{
    ...
    {
        private readonly CommonApiMultiDictionary<int, EventHandler<T>> m_EventHandlers;
        ...
        {
            m_EventHandlers = new CommonApiMultiDictionary<int, EventHandler<T>>();
        ...
        {
            CommonApiLinkedListRange<EventHandler<T>> range = default(CommonApiLinkedListRange<EventHandler<T>>);
